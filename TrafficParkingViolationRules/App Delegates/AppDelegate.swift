...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if let username = UserDefaults.standard.value(forKey: "loginEmailId"), let password = UserDefaults.standard.value(forKey: "loginPassword") {
            initialViewController = mainStoryboard.instantiateViewController(withIdentifier: "HowCanAssetViewController_nav")
        }else {
            initialViewController = mainStoryboard.instantiateViewController(withIdentifier: "LoginVC_nav")
        }
